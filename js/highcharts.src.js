        ...
        H.Pointer.prototype = {
            ...
            reset: function(allowMove, delay) {
              ...
              /* if (chart.series.length>3){
                     console.log("i am now here",chart.series);
                    // console.log("chart",chart.series);
                    for (var j=4;j<chart.series.length;j++)
        ...
        Chart.prototype = {
            ...
            firstRender: function() {
                ...
                each(options.series || [], function(serieOptions) {
                    chart.initforceDG(serieOptions);
            ...
            translate: function() {
                ...
                for (i = 0; i < dataLength; i++) {
                    ...
                    if (stacking && series.visible && !point.isNull && stack && stack[xValue]) {
                      ...
                      //  console.log("pointStack",pointStack );
    ...
    (function(H) {
        ...
        extend(Series.prototype, /** @lends Series.prototype */ {
            ...
            update: function(newOptions, redraw) {
                ...
                // Do the merge, with some d options
